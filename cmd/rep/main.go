...
func main() {
	...
	rootFSs := repConfig.PreloadedRootFS.Paths()
	executorClient, containerMetricsProvider, executorMembers, err := executorinit.Initialize(logger, repConfig.ExecutorConfig, repConfig.CellID, repConfig.Zone, rootFSs, metronClient, clock)
	if err != nil {
